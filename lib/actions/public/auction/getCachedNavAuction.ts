 ...
 * created after it. Use getCachedAuctionId for the realtime listener, which
 * needs an id whether or not the auction is public yet.
 */
export const getCachedNavAuction = unstable_cache(
  async () => {
