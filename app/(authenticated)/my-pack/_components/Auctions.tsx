                ...
                <div className="px-4 py-3 border-b border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark">
                  <div className="flex items-center justify-between gap-2 flex-wrap">
                    <div className="flex items-center gap-2">
                      ...
                      <p className="text-[10px] font-mono tracking-eyebrow uppercase text-text-light dark:text-text-dark">
                  ...
                  {auction.paymentLink && (
                    <div className="mt-2 pt-2 border-t border-border-light dark:border-border-dark flex items-center justify-between gap-3">
                      ...
                      >
                        {auction.paymentStatus === 'PAID' ? (
                          <>
                            <LinkBody icon={<Receipt className="w-3 h-3 shrink-0" aria-hidden="true" />} label="View Receipt" />
                          </>
                        ) : (
                          <>
                            <LinkBody icon={<CreditCard className="w-3 h-3 shrink-0" aria-hidden="true" />} label="Complete Payment" />
                          </>
                        )}
                      </Link>
                    </div>
                ...
                {auction.items.length > 0 && (
                  <>
                    <div className="px-4 py-2 bg-surface-light/50 dark:bg-surface-dark/50 border-b border-border-light dark:border-border-dark">
                      <p className="text-[9px] font-mono tracking-eyebrow uppercase text-muted-light dark:text-muted-dark flex items-center gap-1.5">
                        ...
                        <li key={item.auctionItemId} className="bg-bg-light dark:bg-bg-dark flex gap-4 p-4 sm:p-5">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <Link
                              ...
                              className="group inline-flex items-center gap-1.5 mt-2 text-[10px] font-mono tracking-eyebrow uppercase text-muted-light dark:text-muted-dark hover:text-primary-light dark:hover:text-primary-dark transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-light dark:focus-visible:ring-primary-dark"
