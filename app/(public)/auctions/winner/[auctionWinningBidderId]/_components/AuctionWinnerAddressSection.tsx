...
export function AuctionWinnerAddressSection({ address }: { address: IAddress | null }) {
      ...
      >
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="  text-[10px] uppercase tracking-[0.25em] text-zinc-500 dark:text-muted-dark">Shipping Address</span>
          </div>
