...
export function InstantBuyOrderSummary({ baseAmount, feesCovered, finalAmount, coverFees, requiresShipping, shippingCosts }: Props) {
  return (
    <section
    ...
    >
      <div className="px-4 py-3 border-b border-border-light dark:border-border-dark">
        <h2 className="text-f10 uppercase tracking-[0.25em] text-muted-light dark:text-muted-dark">Order Summary</h2>
      </div>
      <div className="px-4 py-3 space-y-2">
        ...
        {coverFees && (
          <div className="flex justify-between items-center">
            <span className="font-lato text-sm text-muted-light dark:text-muted-dark">
              Processing fee <span className="text-xs opacity-70">(optional)</span>
            </span>
        ...
        {requiresShipping && shippingCosts && (
          <div className="flex justify-between items-center">
            ...
            <span className="font-lato text-sm text-muted-light dark:text-muted-dark">+${Number(shippingCosts).toFixed(2)}</span>
          </div>
        )}
